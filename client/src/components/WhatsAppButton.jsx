...
export default function WhatsAppButton({
  ...
  // Monitor scrolling to show/hide Back to Top button
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <>
      {/* FIXED LEFT SIDE: Currency & Share Buttons */}
      <div style={{
        position: 'fixed',
        bottom: '30px', 
        left: '20px',
        ...
        <div ref={dropdownRef} style={{ position: 'relative' }}>
          ...
          >
            ...
            />
            <span style={{ color: '#111', fontSize: '13px', fontWeight: '600' }}>
              {selected.code}
            </span>
            ...
            <div style={{
              ...
              <div style={{ padding: '8px', borderBottom: '1px solid #f1f5f9' }}>
                <input
                  ...
                  style={{ width: '100%', padding: '6px 10px', fontSize: '12px', border: '1px solid #e2e8f0', borderRadius: '6px', outline: 'none', boxSizing: 'border-box' }}
                />
              </div>
              <div style={{ maxHeight: '200px', overflowY: 'auto' }}>
                {filteredCurrencies.map((item) => (
                  ...
                  >
                    <img src={`https://flagcdn.com/w20/${item.flag}.png`} alt={item.name} style={{ width: '18px', height: 'auto' }} />
                    <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
                      <span style={{ fontSize: '13px', fontWeight: '600' }}>{item.code}</span>
        ...
        >
          <svg viewBox="0 0 24 24" width="20" height="20">
            <path fill="white" d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7a2.5 2.5 0 000-1.39l7-4.11A2.5 2.5 0 0018 7.91a2.5 2.5 0 10-2.5-2.5c0 .23.03.45.08.66l-7 4.11a2.5 2.5 0 100 3.64l7.12 4.18c-.05.2-.08.41-.08.62a2.5 2.5 0 102.5-2.5z"/>
          </svg>
        </button>
      </div>

      {/* FIXED RIGHT SIDE: Gift -> WhatsApp -> Back To Top Vertical Stack */}
      <div style={{ 
        position: 'fixed', 
        bottom: '30px', 
        right: '20px', 
        ...
        >
          <svg viewBox="0 0 24 24" width="20" height="20">
            <path fill="white" d="M20 12v8a2 2 0 01-2 2H6a2 2 0 01-2-2v-8h16zm0-2H4a2 2 0 01-2-2V7a2 2 0 012-2h3.17A3 3 0 0112 3a3 3 0 014.83 2H20a2 2 0 012 2v1a2 2 0 01-2 2zM12 5a1 1 0 00-1 1v1h2V6a1 1 0 00-1-1z"/>
          </svg>
        </button>
        ...
        {/* 3. Back to Top Button (Fades in dynamically when scrolling down) */}
        {showBackToTop && (
          <button 
            onClick={scrollToTop}
            style={{
